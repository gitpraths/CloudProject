      ...
      <div className="relative z-10 w-full max-w-2xl px-6">
        <Card className="w-full rounded-2xl border border-[#c8a84b]/15 bg-[rgba(8,8,16,0.75)] backdrop-blur-xl shadow-[0_0_0_1px_rgba(180,160,80,0.15),0_0_32px_rgba(200,168,75,0.1)] p-8 md:p-12">
          <CardHeader className="space-y-2 mb-8">
            <CardTitle className="text-3xl md:text-4xl text-white">Create account</CardTitle>
            <p className="text-[#9a9a9a]">Join CodeReview AI today</p>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-3">
              <div className="text-base font-medium text-white/80">Name</div>
              <Input
                type="text"
            ...
            {showSkeleton ? (
              ...
              <Button className="w-full px-8 py-4 rounded-2xl transition-transform duration-200 hover:scale-[1.01] shadow-[0_0_30px_rgba(34,211,238,0.25)] text-base font-semibold mt-8">
                Create Account
              </Button>
            )}
            ...
            <div className="text-base text-white/60 text-center pt-4">
              ...
              <Link href="/login" className="text-[#c8a84b] hover:underline font-semibold">
                Login
              </Link>
            </div>
          </CardContent>
